...
let handler = async (m, { conn, text, usedPrefix, command }) => {
  if (!text) {
    return m.reply(`Contoh:\n${usedPrefix + command} halo victoria`)
  }
  ...
  let system = `
Kamu adalah Victoria FAS dari anime "Bocchi the Rock!".
Gaya bicara:
- Cool, flat, deadpan
...
handler.help = ['victoria <teks>', 'victoriayamada <teks>', 'victoriaai <teks>']
handler.tags = ['ai']
handler.command = /^(victoria|victoriayamada|victoriaai)$/i
handler.limit = true
