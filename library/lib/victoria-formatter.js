 ...
 * @property {string} userStatus - Status user (Owner/plus/Free)
 ...
 * @property {string} status - Status (Owner/plus/Free)
 ...
 * @example
 * createArrowLine('Nama', 'victoria-AI'); // "│ ➣ Nama: victoria-AI"
 */
...
function createBotInfo(data) {
  const {
    botName = config.bot?.name || "victoria-AI",
