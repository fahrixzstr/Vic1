...
/**
 * @typedef {Object} victoriaApiAuthShape
 * @property {Object<string, any>} [headers]
 * @property {Object<string, any>} [params]
 */

/**
 * @typedef {Object} victoriaApiProviderShape
 * @property {string} baseURL
 * @property {victoriaApiAuthShape} [auth]
...
/**
 * @typedef {Object} victoriaApiRequestOptions
...
/**
 * @typedef {Object} victoriaApiMultipartFile
 ...
 */
class victoriaApiProvider {
  /**
   * @param {victoriaApiManager} mgr
   * @param {string} name
   */
  ...
  /**
   * @param {string} ep
   * @param {victoriaApiRequestOptions} [opt]
   * @returns {Promise<any>}
   */
  request(ep, opt = {}) {
   ...
   * @param {victoriaApiMultipartFile[]|Object<string, any>} [files]
   * @param {victoriaApiRequestOptions} [opt]
   * @returns {Promise<any>}
   */
...
class CovenantApiProvider extends victoriaApiProvider {
  gpt4(input, opt = {}) {
...
class NeoxrApiProvider extends victoriaApiProvider {
  whatMusic(input, opt = {}) {
...
class CukiApiProvider extends victoriaApiProvider {
...
class ApiFaaProvider extends victoriaApiProvider {
...
class victoriaMainApiProvider extends victoriaApiProvider {
  ytmp4(input, opt = {}) {
...
class NexrayApiProvider extends victoriaApiProvider {
  geminiTts(input, opt = {}) {
...
class YupraApiProvider extends victoriaApiProvider {
  brat(input, opt = {}) {
    return this.get("/api/image/brat", this.asParams(input, "text"), opt);
  }
}

class EmiliabotApiProvider extends victoriaApiProvider {
...
class AzbryApiProvider extends victoriaApiProvider {
...
class YuulabsApiProvider extends victoriaApiProvider {
  tiktok(input, opt = {}) {
    return this.get("/api/downloader/tiktok", this.asParams(input, "url"), opt);
  }
}

class ZenzxzApiProvider extends victoriaApiProvider {
  youtube(input, opt = {}) {
...
class FgsiApiProvider extends victoriaApiProvider {
...
/**
 * API manager terpusat untuk provider eksternal victoria.
 */
class victoriaApiManager {
  /**
  ...
  /**
   * @param {string} name
   * @returns {victoriaApiProviderShape}
   */
  ...
  /**
   * @param {string} name
   * @param {victoriaApiProviderShape} cfg
   * @returns {victoriaApiProvider}
   */
  ...
  /**
   * @param {string} name
   * @param {Partial<victoriaApiProviderShape>} cfg
   * @returns {victoriaApiProvider}
   */
  ...
  makeProviderClasses() {
    return {
      ...
      victoria: victoriaMainApiProvider,
  ...
  makeProviderClient(name) {
    const ProviderClass = this.providerClasses?.[name] || victoriaApiProvider;
  ...
  makeProviders() {
    return {
      ...
      victoria: {
        baseURL: "https://api.victoria.my.id",
      },
    };
  }
...
const victoriaApi = new victoriaApiManager();

export { victoriaApiManager, victoriaApiProvider, victoriaApi };
