import {
  ...
  getRandomReward,
  getProgressiveHint,
} from "./victoria-game-data.js";
import { getDatabase } from "./victoria-database.js";
import { addExpWithLevelCheck } from "./victoria-level.js";
import {
  getGameContextInfo,
  sendGamePreview,
  checkFastAnswer,
} from "./victoria-context.js";
let fetchBuffer;
try {
  fetchBuffer = (await import("./victoria-utils.js")).fetchBuffer;
} catch {}
...
const games = new victoriaGames();

export { victoriaGames, games };
