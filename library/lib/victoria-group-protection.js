import { downloadMediaMessage } from "victoria";
import { isLid, lidToJid, lidToJidSafe } from "./victoria-lid.js";
    ...
    try {
      ...
      if (msgContent) {
        ...
        if (
          ...
          const { downloadMediaMessage } = await import("victoria");
          const fakeMsg = {
            key: cached.key,
          ...
          const { generateWAMessageFromContent } = await import("victoria");
          const cleanContent = {};
